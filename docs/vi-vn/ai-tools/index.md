...
|---|---|---|
| **[ChatGPT](./1-chatgpt)** | Trợ lý đa năng: viết, dịch, đọc file, phân tích | Việc hằng ngày, không cần cài đặt |
| **[Claude Code](./2-claude-code)** | Agent lập trình tự hành trong terminal | Code dự án thật, sửa nhiều file |
| **[Claude Cowork](./3-claude-cowork)** | Agent giao việc văn phòng (không cần code) | Tự động hoá giấy tờ, nghiên cứu |
...
1. **Người mới** → bắt đầu [ChatGPT](./1-chatgpt) (trợ lý đa năng) + [GitHub](./5-github) (kỹ năng nền tảng).
2. **Bắt đầu code với AI** → [Claude Code](./2-claude-code) hoặc [OpenAI Codex](./4-codex).
