...
| **[Windsurf](./14-windsurf)** | AI-native IDE, agent Cascade tự hành | Thích Cursor nhưng muốn agent mạnh hơn |
| **[v0](./17-v0)** | Gõ prompt → ra giao diện web React/Next | Dựng UI/landing nhanh, không rành code |
| **[Replit](./18-replit)** | IDE đám mây + agent tự dựng & deploy | Người mới, làm trên trình duyệt, deploy luôn |
...
| **[Notion AI](./15-notion-ai)** | AI ngay trong workspace ghi chú/tài liệu | Đã dùng Notion, muốn AI viết & hỏi-đáp tài liệu |
| **[Gamma](./16-gamma)** | Tạo slide/web/tài liệu đẹp từ 1 prompt | Làm thuyết trình nhanh, không giỏi design |
| **[ElevenLabs](./19-elevenlabs)** | Giọng nói AI chân thực, clone & lồng tiếng | Voiceover, podcast, dub video đa ngôn ngữ |
...
| Windsurf | ✅ (giới hạn) | Pro ~$20 khi dùng nhiều |
| v0 | ✅ (giới hạn/tháng) | Trả theo token khi build nhiều |
| Replit | ✅ (giới hạn) | Core ~$20 + compute khi deploy |
| n8n | ✅ (self-host: free) | Cloud trả phí nếu không tự host |
| Notion AI | ❌ (gói riêng) | ~$8–10/người/tháng (gắn vào Notion) |
| Gamma | ✅ (400 credit) | Plus/Pro khi cần nhiều slide / bỏ watermark |
| ElevenLabs | ✅ (giới hạn ký tự) | Trả phí khi cần nhiều phút giọng / clone |
