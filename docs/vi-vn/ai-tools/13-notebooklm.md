...
- NotebookLM chạy trên **Gemini 3** (Google công bố chính thức, thay cho Gemini 2.5 Flash trước đó); từ **2/2026**, lõi nâng lên **Gemini 3.1 Pro** — model dùng chung cho Gemini app + NotebookLM + Vertex AI (theo nguồn tới giữa 2026). Google có thể đổi model bất kỳ lúc nào, nhưng đây là **fact đã xác nhận**, không phải tin đồn.
...
| **Audio Overview** | Biến tài liệu thành podcast AI; **4 format**: **Deep Dive** (2 host, mặc định, ~10+ phút), **Brief** (1 host, dưới 2 phút), **Critique** (2 host phản biện tài liệu), **Debate** (2 host tranh luận) | Ra mắt **50+ ngôn ngữ ngày 29/4/2025** (gồm tiếng Việt); tới 2026 nâng full-length lên **80+ ngôn ngữ**. Chọn độ dài Shorter/Default/Longer **hiện English-only** |
...
| Giá (gói phổ biến) | Free / Plus ~$7.99 | ChatGPT Plus ~$20 | Claude Pro ~$20 | Perplexity Pro ~$20 |
...
- Cần **tính toán / phân tích số liệu nặng** (tài chính, thống kê, bảng tính phức tạp) → NotebookLM neo vào *text* chứ không phải công cụ tính, suy luận số học dễ sai → dùng ChatGPT/Claude có **code execution**.
...
NotebookLM hỗ trợ khoảng **200+ quốc gia/vùng** (gồm VN), nhập nguồn + chat hơn **100 ngôn ngữ** (gồm tiếng Việt; con số chính xác dao động theo nguồn tới giữa 2026), và **Audio Overview có tiếng Việt** từ ~4/2025. **Bản miễn phí dùng được bình thường ở VN**, chỉ cần tài khoản Google và đủ **18 tuổi**.
...
::: tip 💡 Lưu ý về free tier (các con số này nhất quán giữa các nguồn)
Bản Free: **100 notebook · 50 nguồn/notebook · ~50 chat/ngày · ~3 audio/ngày · 500.000 từ/nguồn** — đây là **các giới hạn cùng tồn tại**, không phải con số xung đột (50 chat VÀ 3 audio cùng đúng, nhiều nguồn 2026 ghi giống nhau). Điểm chắc chắn: **bản Free đủ rộng cho học tập cá nhân**. Nếu bạn đụng trần thường xuyên → mới tính nâng gói.
:::
...
| **Google AI Ultra** | ~**6 triệu đồng/tháng** (giảm 50% 3 tháng đầu); một số nguồn ghi ~**2,25 triệu đồng** — kiểm lại theo đợt | Bản cao nhất (~$249.99), ra mắt VN |
...
::: tip 🎚️ Chọn format & độ dài podcast (tính năng chính thức)
Trong panel **Customize** bạn chọn được:
- **Format:** **Deep Dive** (2 host, mặc định, ~10+ phút), **Brief** (1 host, dưới 2 phút), **Critique** (2 host phản biện), **Debate** (2 host tranh luận).
- **Độ dài:** ba mức **Shorter (~5+ phút) / Default (~10+ phút) / Longer (~20+ phút)** (công bố tại Google I/O 2025).

⚠️ **Giới hạn thật (quan trọng với độc giả VN):** phần **chỉnh độ dài Shorter/Default/Longer hiện chỉ chạy với English** — bản **tiếng Việt chưa có** nút chỉnh độ dài này (theo nguồn tới giữa 2026). Nếu muốn podcast tiếng Việt **dài/sâu hơn vào một phần cụ thể**, mẹo cộng đồng: tự tạo một bản tóm tắt phần đó, **upload làm nguồn riêng**, rồi để host instructions tập trung vào nó.
:::
...
**(f) Xóa & lưu trữ dữ liệu — cách dọn khi cần:** bạn **xóa được từng nguồn** (chọn nguồn ở cột trái → xóa) hoặc **xóa cả notebook**; khi xóa, nguồn/notebook bị gỡ khỏi tài khoản và không còn truy cập được. Lưu ý: nếu bạn từng bấm 👍/👎, **dữ liệu feedback đã tách khỏi tài khoản** vẫn có thể được giữ tối đa ~3 năm (mục c) — việc xóa notebook không xóa phần feedback đó. Chi tiết & cách quản lý dữ liệu: xem [Help chính thức](https://support.google.com/notebooklm/answer/17004255).

**(g) Tranh chấp giọng nói (đạo đức/pháp lý quanh AI voice):** **15/2/2026**, cựu host NPR **David Greene kiện Google tại Santa Clara County (California)**, cho rằng Audio Overviews tái tạo giọng đặc trưng của ông; **Google phản hồi** rằng giọng nam dựa trên **diễn viên lồng tiếng chuyên nghiệp được trả tiền**. Đây là rủi ro đang tranh chấp — nêu để bạn biết, không kết luận đúng/sai.
:::

::: details ❓ FAQ & lỗi hay gặp (bấm để mở)
**NotebookLM có dùng được ở Việt Nam không? Có cần VPN không?**
Dùng được, **không cần VPN**. Hỗ trợ ~200+ quốc gia (gồm VN), chat + nạp nguồn tiếng Việt OK, Audio Overview có tiếng Việt từ ~4/2025. Chỉ cần tài khoản Google + đủ 18 tuổi.
...
**Audio Overview tiếng Việt có chỉnh được độ dài không?**
**Chưa.** Phần chỉnh độ dài Shorter/Default/Longer **hiện chỉ chạy với English** (theo nguồn tới giữa 2026). Podcast tiếng Việt vẫn tạo được, nhưng chưa có nút kéo độ dài — muốn sâu hơn vào một phần thì tách bản tóm tắt làm nguồn riêng.

**NotebookLM khác Gemini app / Deep Research thế nào?**
Cùng hệ Google nên dễ nhầm, nhưng khác mục đích: **Gemini app** là chatbot tổng quát (trả lời từ kiến thức model + web), **Deep Research** (trong Gemini) tự đi quét web nhiều nguồn để viết báo cáo. Còn **NotebookLM** chỉ trả lời **từ tài liệu BẠN nạp**, kèm trích dẫn về câu gốc — hợp khi bạn đã có sẵn bộ nguồn và cần độ tin + truy vết.
:::
...
- **Kết quả / số liệu:** Lan truyền cực mạnh (**⚠️ số tổng hợp marketing, không có trong nguồn official**: ~**2,1 triệu mention trong 48h**, ~**400 triệu view TikTok trong 3 ngày**). **Nhưng** Google/Spotify tự thừa nhận host “đôi khi phát âm sai, không bao quát đủ”, và có phản ánh **sai fact cơ bản**.
...
**Chắc chắn (nguồn chính thức / báo lớn):** bản chất sản phẩm, cơ chế RAG/Gemini, **model lõi Gemini 3 → Gemini 3.1 Pro** (Google công bố, không phải tin đồn), các tính năng & ngày ra mắt lớn (gồm 4 format Audio + mức độ dài Shorter/Default/Longer English-only), chính sách privacy/training, Discover Sources, Spotify Wrapped, hỗ trợ tiếng Việt.

**Tương đối chắc nhưng dao động (bên thứ ba tổng hợp — felloai/superlore):** các con số giới hạn theo gói (notebooks/nguồn/chat/audio mỗi ngày) và **giá USD theo gói** (gồm Ultra 30TB ~$249.99) — luôn gắn “~/theo nguồn tới giữa 2026”, kiểm lại tại notebooklm.google/plans.

**Mỏng / cần kiểm:** *“hallucination dưới 2%”* (số marketing); số viral Spotify (~2,1tr mention / ~400tr view — tổng hợp marketing); chi tiết case study cá nhân (paraphrase, không gắn handle/URL); tình trạng **ưu đãi SV VN** (đợt 2025 đã hết, đợt sau tùy Google); một số bản tóm tắt tự động có thể vẫn ra tiếng Anh (notebooklm.in); chi tiết thread HN (chỉ xác nhận tồn tại).
