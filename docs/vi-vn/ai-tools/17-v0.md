...
::: tip 💡 Bản đại tu 2/2026 thêm tính năng nhưng KHÔNG đổi giá
...
::: warning ⚠️ Đừng trích sai con số
...
| **Premium** (cá nhân) | ~20 USD/tháng | ~20 USD credit/tháng | ⚠️ **Đang sunset** — chỉ còn cho user cũ; user mới **KHÔNG đăng ký được** (xác nhận qua community.vercel.com). Message không giới hạn cứng, Figma import, v0 API, mua thêm credit |
...
::: warning 📌 Gói Premium đang bị sunset — chọn gói khác thay thế
...
**Hỏi: Gói Premium (~20 USD cá nhân) biến mất rồi — giờ chọn gói nào thay thế?**
→ Premium đang **sunset**: user cũ giữ được, **user mới không đăng ký được** (xác nhận qua `community.vercel.com`). Với user mới, lựa chọn còn lại là **Free** (giới hạn ~7 message/ngày, hợp để thử) hoặc **Team ~30 USD/user/tháng** (cộng tác + nhiều credit hơn). Lưu ý cả Free lẫn Team đều **không opt-out training** — cần kiểm soát dữ liệu thì phải **Business+**.
...
6. **Bảo mật:** **Free và Team** (kể cả Team trả phí) **có thể dùng dữ liệu của bạn để train**; muốn opt-out phải lên **Business** (opt-out mặc định) / **Enterprise** (không bao giờ train).
:::
