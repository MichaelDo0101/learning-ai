...
description: 'Hướng dẫn thực chiến Google Gemini cho người Việt: gói & giá tại VN (Plus/Pro/Ultra trả bằng ₫, sinh viên 1 năm Pro free), Deep Research, NotebookLM, AI Studio, và bước ngoặt Gemini CLI → Antigravity (18/6/2026) — kèm bài tập và case study có nguồn.'
---
...
**💸 Lợi ích thực tế:** một trợ lý đọc Gmail/Drive/Docs của bạn, tạo ảnh/video, nuốt cả tài liệu 1 triệu token — và **sinh viên VN được tặng 1 năm Google AI Pro miễn phí** (gồm Gemini Pro + 2TB). Đỡ thuê trợ lý, đỡ thức khuya.
:::
...
- **Hiểu bước ngoặt Gemini CLI → Antigravity** (18/6/2026) và quyết định có nên phụ thuộc vào nó không.
...
- **Mô hình nền (foundation models)** = dòng model Gemini bên dưới: **3 Pro, 3.1 Pro, 3.5, Flash, Flash-Lite, Deep Think…**. Đây là "động cơ".
...
**Gemini 3** (bản nền tảng) ra mắt **18/11/2025**, được Google mô tả là "mô hình thông minh nhất" — suy luận mạnh, đa phương thức (text/ảnh/video/audio/code), cửa sổ ngữ cảnh **1 triệu token**. Bản **Gemini 3.1 Pro** ra khoảng **19/02/2026**. Tại **Google I/O 2026** (tháng 5) Google giới thiệu thêm **Gemini 3.5**, **Gemini Omni**, **Spark**, **Antigravity 2.0**. URL app chính thức: **https://gemini.google.com**.

**Những việc Gemini làm tốt (trong app):**

| Nhóm việc | Làm được gì | Có ở đâu |
|---|---|---|
| **Chat đa phương thức** | Hỏi đáp text/ảnh/video/audio/code với model 3.5 Flash + nhiều cấp 3.1 Pro | Cả bản Free |
| **Deep Research** | Agent tự duyệt web nhiều nguồn, lập kế hoạch, tổng hợp báo cáo có trích dẫn | Free (mạnh hơn ở Pro/Ultra) |
| **Deep Think** | Chế độ suy luận sâu (nhiều giả thuyết song song); Google nói đạt mức huy chương vàng IMO 2025 | Ultra |
...
**Gemini Omni** — model "tạo bất cứ thứ gì từ bất cứ input nào", bắt đầu với video, có trên Plus/Pro/Ultra. **Spark** (agent 24/7) và **Project Genie** dành cho Ultra. *Lưu ý: đây là tính năng I/O 2026 mới, một số đang Beta hoặc giới hạn thị trường US — kiểm tra lại trước khi tin là đã có ở VN.*
:::
...
|---|---|---|
| **Gemini** (Google) | Đa phương thức (ảnh/video/audio), context 1M token, tích hợp Workspace | Sống trong Google, cần video/ảnh, tài liệu cực dài, giá VN tốt |
| **ChatGPT** (OpenAI) | All-rounder, hệ sinh thái plugin/integration rộng nhất | Cần một trợ lý "tất cả trong một" đa năng |
| **Claude** (Anthropic) | Code chất lượng cao, suy luận đa file, tài liệu dài/formal, an toàn | Lập trình nghiêm túc, viết dài bám-spec, ưu tiên an toàn |
| **Perplexity** | Search-first, độ chính xác trích dẫn cao nhất | Tra cứu cần nguồn đáng tin, nghiên cứu nhanh có citation |
| **Grok** (xAI) | Truy cập trực tiếp luồng X, tốc độ nhanh nhất | Theo dõi tin nóng / mạng xã hội real-time |
...
Google đã **chính thức bán cả 3 gói tại VN** (không cần VPN). Nhiều báo trong nước (VnExpress, VietnamNet, vietbao) đưa tin gói **~122.000₫/tháng (~$5)**. Đặc biệt cho người học: **sinh viên / HSSV VN được tặng 1 năm Google AI Pro miễn phí** (gồm Gemini Pro + 2TB), hết hạn thì tính theo giá 489.000₫/tháng. **Bản Free không cần thẻ.**
...
- **Sinh viên VN: nhớ kích hoạt ưu đãi 1 năm Pro miễn phí** trước khi nghĩ tới việc trả tiền.
:::
...
**Cấu hình ngữ cảnh cho dự án** — tạo một file mô tả dự án (kế thừa khái niệm **GEMINI.md** của Gemini CLI): đặt mô tả dự án, quy ước code, lệnh build, để agent đọc đúng bối cảnh:
...
MCP servers cấu hình trong `~/.gemini/settings.json` (Gemini CLI) hoặc plugin Antigravity tương ứng.

::: warning 📁 Đường dẫn cấu hình Antigravity có thể khác
Antigravity mới — đường dẫn/định dạng file context và cấu hình MCP **có thể khác** Gemini CLI cũ. Kiểm tại **antigravity.google/docs/cli-getting-started** trước khi làm theo.
:::

→ **Verify:** chạy `agy` trong repo, agent đọc được GEMINI.md và làm đúng quy ước bạn ghi (ví dụ không đụng vào /legacy).
...
- Blog Xiangyu Yin (literature review materials science) — *trải nghiệm cá nhân researcher*.
- research.google blog (STOC 2026) — *official Google*.
- UCStrategies / Medium @nitinfab (NotebookLM QBR & battlecard) — *tổng hợp doanh nghiệp*.
...
4. **Người Việt dùng được hợp pháp**; bản **Free hào phóng**, và **sinh viên VN được 1 năm Pro miễn phí** — kích hoạt trước khi trả tiền.
5. **Bước ngoặt CLI:** Gemini CLI ngừng phục vụ cá nhân **18/6/2026** → dùng **`agy` (Antigravity)**. Để agent sửa file thì **commit git + review diff**.
:::
...
- **Tương đối chắc (báo VN uy tín):** gói ~122.000₫/$5 tại VN, ưu đãi sinh viên 1 năm Pro miễn phí.
- **Tham khảo/bên thứ ba (gắn "~"/hedge):** mọi benchmark so sánh (SWE-bench, tỷ lệ ảo trích dẫn 18% vs 3%), giá API per-token, chi tiết "1.000 req/ngày free" của Gemini CLI cũ, đường dẫn cấu hình Antigravity mới.
- **Nguồn mỏng (nên kiểm lại):** danh sách phương thức thanh toán nội địa VN chính xác; tên/chi tiết model I/O 2026 mới nhất (Gemini Omni/3.5/Spark) còn đang roll-out, một phần giới hạn US.
