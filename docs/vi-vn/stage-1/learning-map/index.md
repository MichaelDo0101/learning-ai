...
## 🧪 Hands-on Lab — Build prototype AI app trong 2 giờ

::: tip 🎯 Mục tiêu Stage 1
2 giờ: từ ý tưởng → prototype trực quan có **AI feature work** trên Lovable hoặc Bolt.new.
:::

### Stack PM/người mới 2026

| Tool | Cost | Use |
|------|------|------|
| **Lovable** | Free 5 prompts/day | No-code AI app builder |
| **Bolt.new** | Free tier | Alternative Lovable |
| **v0.app** | Free tier | UI-first builder |
| **ChatGPT free** | Free | Brainstorm + write prompts |

### Step 1. Pick ý tưởng (15 phút)

Framework "Problem-Solution-Audience":
```
Problem: [pain bạn gặp hằng ngày]
Audience: [ai gặp pain này nhất]
Solution: [AI app giải pain]
```

Ví dụ:
- Problem: HS lớp tôi khó nhớ từ vựng tiếng Anh
- Audience: HS lớp 9 trường THCS XYZ
- Solution: AI flashcard tự gen example sentence + game review

### Step 2. Spec với ChatGPT (15 phút)

```
Tôi muốn build [solution]. Đối tượng [audience], pain [problem].

Cho tôi:
1. 3 core feature (must-have only)
2. User flow chính (5 step)
3. UI mockup description
4. AI API nào cần (OpenAI/Claude/Gemini)
5. Estimate cost/tháng

Format: Markdown.
```

### Step 3. Build với Lovable (60 phút)

Paste spec vào Lovable → AI gen prototype. Iterate 3-5 prompts để fix UI + add features.

### Step 4. Test + share (30 phút)

- Test 5 user flow chính
- Share link cho 5 người — đo feedback
- Document: ai sẽ paying? Price bao nhiêu?

---

## 🎯 Knowledge Check — Stage 1 (5 câu)

::: details 1. PM/người mới 2026 nên dùng tool nào đầu tiên?
**A.** Cursor (cho dev)
**B.** Lovable / Bolt.new / v0 (no-code AI) ✅
**C.** WordPress
**D.** Excel

**Đáp án: B** — No-code AI app builders cho non-dev. Sabrine Matos (Brazil, non-tech): $456K ARR/3 tháng với Lovable.
:::

::: details 2. Vibe Coding khác traditional ở?
**A.** Tốc độ slower
**B.** Mô tả intent → AI gen → run + iterate (không deep-read syntax) ✅
**C.** Cần degree CS
**D.** Chỉ Python

**Đáp án: B** — Karpathy T2/2025: "vibe coding" = describe intent, accept code, run, iterate. Collins Word of the Year 2025.
:::

::: details 3. 63% vibe coding user là?
**A.** Senior dev
**B.** Non-developer (PM, designer, founder) ✅
**C.** Student CS
**D.** Manager

**Đáp án: B** — TechTimes Q1/2026: 63% vibe coding user là non-developer.
:::

::: details 4. Pattern PRODUCT THINKING quan trọng?
**A.** Code đẹp
**B.** Pain rõ + niche cụ thể + ship sớm ✅
**C.** Plan kỹ tránh fail
**D.** Funding lớn

**Đáp án: B** — PM AI thành công 2026: identify pain THẬT + niche RẤT cụ thể + ship sớm. Anh Lư "Chợ trời sinh viên" niche 1 trường ĐH.
:::

::: details 5. Stage 1 output kỳ vọng?
**A.** 1 enterprise SaaS
**B.** 1 prototype có user test feedback + decision continue/pivot ✅
**C.** 1 mobile app native
**D.** Câu trả lời lý thuyết

**Đáp án: B** — Stage 1 = product thinking + prototype. Ship sớm, test real user, decide next. Production-ready là Stage 2.
:::

**Score**:
- 5/5 ✅ Sẵn sàng Stage 2
- 3-4/5 ⚠️ Read chapters detail
- <3/5 ❌ Back to Stage 0

---

::: warning 💡 Mantra Stage 1
> *"Nghĩ về SẢN PHẨM trước khi nghĩ về CODE.*
> *AI làm code dễ. Decide WHAT to build vẫn cần human judgment + customer interview."*
:::
