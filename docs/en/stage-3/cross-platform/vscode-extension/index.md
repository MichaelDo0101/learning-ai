...
<!-- ![placeholder: VS Code extension ecosystem diagram showing expandable areas: sidebar, editor, status bar, command palette, Chat panel](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image1.png) -->
![VS Code extension ecosystem diagram showing the areas extensions can extend: sidebar, editor, status bar, command palette, and Chat panel](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image1.png)
...
<!-- ![placeholder: VS Code extension architecture diagram showing Extension Host vs editor main process](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image2.png) -->
![VS Code extension architecture diagram showing the Extension Host process and the editor main process](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image2.png)
...
<!-- ![placeholder: AI Project Bot preview showing sidebar templates, @project-bot chat panel, and right-click menu](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image3.png) -->
![Preview of the AI Project Bot extension showing the sidebar template list, the @project-bot chat panel, and the right-click menu](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image3.png)
...
<!-- ![placeholder: package.json screenshot with contributes field highlighted](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image4.png) -->
![Screenshot of the package.json file in the editor with the contributes field highlighted](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image4.png)
...
<!-- ![placeholder: VS Code extension debugging screenshot showing Extension Development Host and Hello World message](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image5.png) -->
![Screenshot of debugging a VS Code extension, showing the Extension Development Host window and the Hello World message](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image5.png)
...
<!-- ![placeholder: Screenshot showing AI Project Bot icon and project template list in VS Code sidebar](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image6.png) -->
![Screenshot showing the AI Project Bot icon and the project template list in the VS Code sidebar](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image6.png)
...
<!-- ![placeholder: Screenshot showing project name input and folder picker dialog after clicking a template](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image7.png) -->
![Screenshot showing the project name input box and folder picker dialog after clicking a template](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image7.png)
...
<!-- ![placeholder: VS Code Chat screenshot showing @project-bot, /explain command, and streaming response](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image8.png) -->
![Screenshot of the VS Code Chat panel showing @project-bot, the /explain command, and a streaming response](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image8.png)
...
<!-- ![placeholder: Screenshot of editor context menu showing AI items after selecting code](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image9.png) -->
![Screenshot of the editor context menu showing AI items after selecting code](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image9.png)
...
<!-- ![placeholder: Screenshot of explorer with multi-selected files and AI analysis context menu item](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image10.png) -->
![Screenshot of the explorer with multiple selected files and an AI analysis item in the context menu](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image10.png)
...
<!-- ![placeholder: Screenshot of AI Bot icon displayed in VS Code status bar](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image11.png) -->
![Screenshot of the AI Bot icon displayed in the VS Code status bar](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image11.png)
...
<!-- ![placeholder: Screenshot of AI Project Bot extension page in VS Code Marketplace](../../../../vi-vn/stage-3/cross-platform/vscode-extension/images/image12.png) -->
